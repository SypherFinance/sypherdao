...
contract SypherToken is ERC20Permit {

    constructor() ERC20("Sypher Finance", "SYP") ERC20Permit("Sypher Finance") {
    ...
    */
        ...
        external
    {
        ...
        require(nonce == sigNonces[signatory]++, "FarmToken::delegateBySig: invalid nonce");
